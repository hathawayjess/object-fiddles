...
user1.name = 'Jessica Hathaway';
user1.pwHash = "aAAAa+d2xBy";
user1.username = 'hathawayjess';
...
// Create a function called MakePerson which takes in name, birthday, ssn as its parameters and 
//returns a new object with all of the information that you passed in.
  ...
  console.log(MakePerson('Jess', 'February', 123));
...
or a credit card object. Now, create a bindCard function that takes in a person object as its first parameter 
and a creditcard object as its second parameter. Have bindCard merge the two parameters together into a new 
object which contains all the properties from the person as well as the creditcard.
*/
...
function bindCard(person, creditcard) {
  ...
  for (var b in creditcard) {
    personAndCard[b] = creditcard[b];
  }
